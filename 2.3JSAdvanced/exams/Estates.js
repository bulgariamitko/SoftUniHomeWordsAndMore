function processEstatesAgencyCommands(commands) {
    ...
    Object.prototype.validateIntegerRange = function(value, variableName, minValue, maxValue) {
        ...
        if (value < minValue || value > maxValue) {
            throw new Error(variableName + " should be an integer in the range [" + minValue + " " + maxValue + "]");
        }
    };
    ...
    var EstatesEngine = (function() {
        ...
        function executeCommand(command) {
            ...
            case 'find-sales-by-location':
                return executeFindOffersByLocationCommand(cmdArgs[0], SaleOffer);
            case 'find-rents-by-location':
                return executeFindOffersByLocationCommand(cmdArgs[0], RentOffer);
        ...
        function executeFindRentsByPriceCommand(minPrice, maxPrice) {
            Object.prototype.validateIntegerRange(minPrice, "minPrice", Number.NEGATIVE_INFINITY, Number.MAX_VALUE);
            Object.prototype.validateIntegerRange(maxPrice, "maxPrice", Number.NEGATIVE_INFINITY, Number.MAX_VALUE);
