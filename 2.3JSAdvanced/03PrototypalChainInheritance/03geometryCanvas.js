...
var shapes = (function() {
	...
	var circle = shape.extend({
		...
		draw: function() {
			...
			ctx.beginPath();
			ctx.arc(pointO._x, pointO._y, this.radius, 0, 2 * Math.PI);
	...
	var rectangle = shape.extend({
		...
		draw: function() {
			...
			ctx.fillStyle = this._color;
			ctx.fillRect(pointA._x, pointA._y, this._width, this._height);
			ctx.strokeRect(pointA._x, pointA._y, this._width, this._height);
		},
		toString: function() {
	...
	var triangle = shape.extend({
		...
		draw: function() {
			...
			ctx.moveTo(pointB._x, pointB._y);
			ctx.moveTo(pointC._x, pointC._y);
			ctx.closePath();
			ctx.stroke();
			ctx.fillStyle = this._color;
			ctx.fill();
